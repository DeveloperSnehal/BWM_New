            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-banner text-center">
                        <h2 class="title">Request a Pickup</h2>
                        <ul class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Request a Pickup</li>
                        </ul>
                    </div>
...
<div class="section login-register-section section-padding-02" style="margin-bottom: 5%;">
    <div class="container">
