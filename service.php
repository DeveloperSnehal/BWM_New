...
<div class="section techwix-choose-us-section section-padding"
    style="background-image: url(assets/images/bg/choose-us-bg.jpg);padding-top: 100px;">
    <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="choose-us-item">
                            <div class="choose-us-img">
                                <a href="choose-us.html"><img src="assets/images/choose-us1.jpg" alt=""></a>
                                <div class="choose-us-content">
                                    <h3 class="title">Biomedical Waste</h3>
                                    <p>We prioritize biomedical waste disposal safety, employing innovative technologies
                                        and approved techniques to destroy germs and decrease environmental effect.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Choose Us Item End -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="choose-us-item">
                            <div class="choose-us-img">
                                <a href="choose-us.html"><img src="assets/images/choose-us2.jpg" alt=""></a>
                                <div class="choose-us-content">
                                    <h3 class="title">Construction and Demolition Waste</h3>
                                    <p>Debris generated during demolition is handled, sorted, and disposed of carefully
                                        in compliance with environmental rules, thereby minimising environmental damage.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="choose-us-item">
                            <div class="choose-us-img">
                                <a href="choose-us.html"><img src="assets/images/choose-us3.jpg" alt=""></a>
                                <div class="choose-us-content">
                                    <h3 class="title">Hazardous Waste</h3>
                                    <p>Our strategy contains careful identification, classification, and containment of
                                        hazardous items, with a focus on worker, community, and environmental safety.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="choose-us-item">
                            <div class="choose-us-img">
                                <a href="choose-us.html"><img src="assets/images/choose-us1.jpg" alt=""></a>
                                <div class="choose-us-content">
                                    <h3 class="title">Oil Waste</h3>
                                    <p>We start by sorting motor oil, pumps, and industrial lubricants. We recycle and
                                        recondition oil waste using innovative technologies and certified methods.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Choose Us Item End -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="choose-us-item">
                            <div class="choose-us-img">
                                <a href="choose-us.html"><img src="assets/images/choose-us2.jpg" alt=""></a>
                                <div class="choose-us-content">
                                    <h3 class="title">Paper Waste</h3>
                                    <p>We provide safe and eco-conscious paper trash collection, recycling, and
                                        management through this overall strategy, contributing to conservation of trees.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="choose-us-item">
                            <div class="choose-us-img">
                                <a href="choose-us.html"><img src="assets/images/choose-us3.jpg" alt=""></a>
                                <div class="choose-us-content">
                                    <h3 class="title">Rubber Waste</h3>
                                    <p>We use eco-friendly recycling procedures and certified methods to recycle and
                                        repurpose rubber waste, significantly lowering its environmental impact while
                                        conserving important resources.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Choose Us Item End -->
