...
<!-- About Start -->
<div class="section techwix-about-section-07 section-padding" style="padding-top: 120px; padding-bottom: 80px;">
        ...
        <div class="video-wrap" style="background-image: url(assets/images/bg/video-bg.jpg);">
            ...
            <div class="shape-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="602px" height="640px">
                    ...
                    <path fill-rule="evenodd" fill="rgb(65, 183, 254)"
                        d="M457.662,0.334 L601.963,129.999 L144.337,639.281 L0.35,509.616 L457.662,0.334 Z" />
                    <path fill="url(#PSgrad_0)"
                        d="M457.662,0.334 L601.963,129.999 L144.337,639.281 L0.35,509.616 L457.662,0.334 Z" />
                </svg>
            </div>
