            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-banner text-center">
                        <h2 class="title">EPR Compliance</h2>
                        <ul class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">EPR Compliance</li>
                        </ul>
                    </div>
...
<div
    ...
    <div class="service-content">
        <div class="service-list" style="text-align: justify; padding: 3%;">
            <h5 style="text-align: justify; padding:2%;">As a Key Producer some responsibilities that become mandatory are:</h5>
